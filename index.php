      ...
      <section class="screen">
        <article class="promo" aria-label="땡스페이 비자 카드">
          ...
          <ul class="list" aria-label="혜택 목록">
            <li><img src="/assets/icons/icon-main-card-benefit01@2x.png" width="24px" height="24px" style="margin-top:6px"><span>THX 가맹점 <b>10% 할인</b></span></li>
            <li><img src="/assets/icons/icon-main-card-benefit02@2x.png" width="24px" height="24px" style="margin-top:6px"><span>멤버스 포인트 <b>2~5% 적립</b></span></li>
            <li><img src="/assets/icons/icon-main-card-benefit03@2x.png" width="24px" height="24px" style="margin-top:6px"><span>THX MALL <b>보너스 포인트</b></span></li>
          </ul>
